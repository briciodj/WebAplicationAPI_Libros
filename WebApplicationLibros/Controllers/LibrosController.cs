...
namespace WebApplicationLibros.Controllers
{
    ...
    {
        private readonly WebApplicationLibrosContext _context;

        public LibrosController(WebApplicationLibrosContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Libros>> PostLibros(Libros libros)
        {
          if (_context.Libros == null)
          {
              return Problem("Entity set 'WebApplicationLibrosContext.Libros'  is null.");
          }
